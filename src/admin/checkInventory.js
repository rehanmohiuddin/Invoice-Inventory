      ...
      <TableBody>
        {stall.items.map((stall) => (
          ...
          <TableRow key={stall.ItemName}>
            ...
            <TableCell align="right">{stall.Uom}</TableCell>
            <TableCell align="right">{stall.crates}</TableCell>
            ...
            <TableCell align="right">{stall.sold?stall.Qty-stall.sold:stall.Qty}</TableCell>
          </TableRow>
        )
